                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            ...
                            <hr>
                             ...
                             <div class="container">
                                <?php foreach($alldata as $valuue) { ?>
                                    <div style="text-align: center;">
    <img src="<?php echo asset(Storage::url($valuue['profile_pic'])); ?>" width="100" height="100">
</div>

        <div class="user-details">
            <h1>{{$valuue['name']}}</h1>
            <p>Email: {{$valuue['email']}}</p>
            
        </div>
                                <?php } ?>
    </div>
    <div class="footer">
    <a href="{{ route('adminprofile.edit',auth()->user()->id) }}" class="btn btn-primary">Edit Profile</a>
</div>
