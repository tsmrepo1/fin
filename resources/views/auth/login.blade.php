                    ...
                    <div class="form-container form-container--login row box-shadow border-radius--custom mx-1 mx-md-0">
                        ...
                        <div class="col-12 col-md-12 col-lg-6 form-container__content-col px-3 py-4 p-md-4 p-lg-5 bg--white">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        The credential doesn't matched!
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                </div>
                                @endif
                            </div>
                            <form action="{{ route('login') }}" method="POST" class="form login-form" id="loginForm">
                                @csrf
                            ...
                            <p class="text--para mt-3 mb-0 text-center">
                                ...
                                <a href="{{ route('register') }}" class="redirecting-link--register fw-semibold text-decoration-underline">
                                    Register Now
                                </a>
                            </p>
                        </div>
